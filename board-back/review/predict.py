...
max_len = 80
model = load_model('./review/GRU_model.h5')

with open('./review/tokenizer.pickle', 'rb') as handle:
    tokenizer = pickle.load(handle)

stopwords = ['는데', '습니다', '네요', '어요', '었', '있', '은', '는', '이', '가', '하', '고', '아', '거', '것', '의', '도', '다', '한', '에',
             '을', '를', '인', '듯', '과', '와', '네', '들', '듯', '지', '임', '게', '어']
