...
class ListDiaryComponent extends Component {
    ...
    setSearchContent = (e) => {
        BoardService.getSearchDiarys(this.state.searchInput, 1).then((res) => {
            this.setState({
                boards: res.data.list,
                p_num: res.data.pagingData.currentPageNum,
                paging: res.data.pagingData,
    ...
    readBoard(no) {
        ...
        /* 조회수 증가 */
        BoardService.setDiaryCounts(no);
    }
    ...
    listBoard(p_num) {
        ...
        if(this.state.search_boards.length !== 0){
            BoardService.getSearchDiarys(this.state.searchInput, p_num).then((res) => {
                this.setState({
                    boards: res.data.list,
                    p_num: res.data.pagingData.currentPageNum,
                    paging: res.data.pagingData,
            ...
            <>
                ...
                <div className="community-main">
                    ...
                    <div className="community-best">
                        ...
                        {this.state.best.length != 0 && <BestCommunityDiaryItems diarys={this.state.best} />}
